...
describe('validatePresetConfig - resolverGeneration', () => {
  ...
  it('throws if invalid resolverGeneration is provided', () => {
    expect(() =>
      ...
      '[@eddeee888/gcg-typescript-resolver-files] ERROR: Validation - presetConfig.resolverGeneration must be an object, "disabled", "recommended" or "full" (default is "recommended")'
    );
  });
});
